...
const RegistroA = () => {
    return (
        <div className="bg-white p-8 max-w-md mx-auto my-8 rounded-md shadow-md">
            ...
            <h1 className="text-2xl font-semibold mt-2">Airbnb is a comminity where anyone can belong</h1>
            <p className="text-gray-600 text-sm mt-4">
                The ensure this we're sking you to commit to the following:
            </p>
            <p className="text-gray-600 text-sm mt-4">
                I agree to treat everyone in the Airbnb community-regardlessof their race, religion, nation origen,
                ethnicity, skin color, disability, sex, gender identity, sexual orientation or age-with respect,
                and without judgement or bias.
            </p>
            <a href="#" className="text-blue-500 mt-4 hover:underline flex items-center">
                Learn more
                <span className="ml-1">
                    <svg
